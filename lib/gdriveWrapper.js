...
gdriveWrapper.prototype.updateFile = function(
  fileId, filename, sourceFile,  options, complete)
{
  var extension = '';
...
gdriveWrapper.prototype.listFiles = function(gdriveDirectory, complete) {
  const wrapperThis = this;
  this.getMetaForFilename(gdriveDirectory, function(err, parentMeta) {
    if (err) {
      complete(err);
